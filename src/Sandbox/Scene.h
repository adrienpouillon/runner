...
//#define BASIC_VELOCITY_PLAYER 0.1f
#define MAX_VELOCITY_PLAYER 16.f

#define INCREASE_VELOCITY_PLAYER 0.001f
#define REDUCE_VELOCITY_PLAYER 0.004f
#define MULTIPLICATOR_MAX_VELOCITY_PLAYER 0.002f
